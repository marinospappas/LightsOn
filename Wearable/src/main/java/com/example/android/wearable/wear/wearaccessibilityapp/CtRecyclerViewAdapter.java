...
public class CtRecyclerViewAdapter extends RecyclerView.Adapter<CtRecyclerViewAdapter.Holder> {

    private static final String TAG = "CtRecyclerViewAdapter";
    ...
    public CtRecyclerViewAdapter(Context context, List<SmartHouse.DataSet> items) {
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        Log.i(TAG,"in onBindViewHolder, Item: " + item.mItemName + " position " + pos);
